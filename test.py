...
for i in range(n_test):
  ...
  plt.subplot(1,3,2)
  plt.imshow(seg)
  np.save(f'/content/drive/MyDrive/tinyunet/groundtruthsave/seg_{i}.npy', seg)
  plt.subplot(1,3,3)
  ...
  np.save(f'/content/drive/MyDrive/tinyunet/groundtruthsave/y_pred_{i}.npy', y_pred_np)
  plt.show()
